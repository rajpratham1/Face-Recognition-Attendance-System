...
1. **Show Registration**: 
   ...
   - Fill details
   - Scan face
   - Explain face descriptor storage

2. **Show Teacher Session**:
   - Login as teacher
   - Create live session
   - Show GPS capture
   - Explain geofencing

3. **Show Student Attendance**:
   - Login as student
   - Show live sessions
   - Mark attendance
   - Show face recognition + GPS check
