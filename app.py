...
def save_face():
    ...
    # Store the face descriptor (128-D vector) as a string
...
def mark_attendance():
    ...
    if request.method == 'POST':
        ...
        # Threshold (0.6 is common for face-api.js)
        if distance < 0.6:
            ...
            return jsonify({'success': False, 'message': f'Face verification failed! (dist: {distance:.2f})'})
